...
<main>
  ...
  <h2>Where it helps, and where you still think</h2>
  <p>IAMAI hands you the findings and a plan; you bring the context. It will tell
  you nobody should hold Global Administrator around the clock. What it cannot
  know is that the account holding it runs your payroll export every Friday. So
  read every recommendation against the tenant in front of you. And to be plain:
  this is a working tool, not a compliance certificate or a formal audit.</p>
